...
<section class="content">
    <div class="page" style="max-width:1100px;margin:auto;">
        ...
        <div class="candidate-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-wrapper candidate-answers" style="max-height: 400px; overflow-y: auto;">
        ...
        <div class="card" style="margin-top:16px;">
            ...
            <div style="font-size:15px;line-height:1.7;color:#334155;background:#f8fafc;padding:16px;border-radius:10px;border-left:4px solid #2563eb;">
                {!! nl2br(e($personalityNarrative)) !!}
            </div>
            <div style="margin-top:10px;font-size:12px;color:#64748b;">
                Catatan: Ringkasan ini dihasilkan otomatis sebagai alat bantu HR dan <strong>bukan diagnosis psikologis</strong>.
            </div>
        </div>
        ...
        <div class="card" style="margin-top:16px;">
            ...
            <table class="table-custom">
                <tbody>
                    @php
                        $documents = ['KTP' => 'ktp_ic', 'SKB' => 'skb', 'SIM' => 'sim'];
                    @endphp
                    @foreach ($documents as $label => $type)
                        @php
                            $doc = \App\Models\ApplicantDocument::where('applicant_id', $candidate->id)->where('document_type', $type)->first();
                        @endphp
                        <tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(ctx, {
            type: 'radar',
            data: {
                labels: ['Focus', 'Consistency', 'Social', 'Emotional', 'Obedience', 'Honesty'],
                datasets: [{
